...
const items = [
  {
    ...
    text: 'Плавающие помутнения, ниточки, паутинки, тени на светлом фоне',
  },
  {
    icon: '/img/B4_2.svg',
    tag: 'СРОЧНО',
    ...
    text: 'Краткие световые феномены, искры, блики, фотопсии',
  },
  {
    icon: '/img/B4_3.svg',
    tag: 'СРОЧНО',
    ...
    text: 'Ощущение мутности, пленки, расплывчатости изображения',
  },
  {
    icon: '/img/B4_4.svg',
    tag: 'ПЛАНОВО',
    ...
    text: 'Рябь, мерцающие контуры, звездочки перед глазами',
  },
  {
    icon: '/img/B4_5.svg',
    tag: 'СРОЧНО',
    ...
    text: 'Черное, белое или мутное пятно, которое не “уплывает”',
  },
  {
    icon: '/img/B4_6.svg',
    tag: 'ПЛАНОВО',
    ...
    text: 'Особенно важно при сочетании с болью и покраснением',
  },
  {
    icon: '/img/B4_7.svg',
    tag: 'ПЛАНОВО',
    ...
    text: 'Может быть связано с сухим глазом или воспалением поверхности глаза',
  },
  {
    icon: '/img/B4_8.svg',
    tag: 'СРОЧНО',
    ...
    text: 'Односторонние симптомы требуют особенно внимательной диагностики',
  },
] as const
