...
const cards = [
  {
    ...
    text: 'Подбираем объём обследования по жалобам: от\nосмотра до расширенной диагностики сетчатки,\nстекловидного тела и зрительного нерва',
  },
  {
    n: '02',
    title: 'Осмотр глазного дна',
    text: 'Позволяет оценить состояние сетчатки,\nстекловидного тела и периферии глаза',
  },
  {
    n: '03',
    title: 'Измерение внутриглазного давления',
    text: 'Важно при тумане, боли, радужных кругах и\nподозрении на глаукому',
  },
  {
    n: '04',
    title: 'УЗИ глаза',
    text: 'Назначается при непрозрачных средах и для\nоценки состояния стекловидного тела и сетчатки',
  },
  {
    n: '05',
    title: 'Периметрия',
    text: 'Нужна при выпадении участков поля зрения и\nподозрении на глаукому или неврологические причины',
  },
] as const
        ...
        <div className="mt-9 grid grid-cols-1 gap-4 lg:mt-11 lg:grid-cols-3 lg:gap-5">
          {cards.map((c, idx) => (
            ...
            >
              ...
              <div className="relative mt-3 whitespace-pre-line text-[13px] leading-[1.25] text-white/75">
                {c.text}
              </div>
            </motion.div>
          ))}
